...
const LoginPage: React.FC = () => {
  ...
  const demoCredentials = [
    { email: 'admin@atithi.com', password: 'admin123', role: 'Hotel Manager' },
    { email: 'receptionist@atithi.com', password: 'receptionist123', role: 'Front Desk Agent' },
    { email: 'student@atithi.com', password: 'student123', role: 'Training Student' },
  ];
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Property Management System by Naveen Kumar</p>
          </div>
